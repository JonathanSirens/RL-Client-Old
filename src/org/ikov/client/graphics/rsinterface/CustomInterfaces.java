package org.ikov.client.graphics.rsinterface;
...
import org.ikov.client.RSInterface;
import org.ikov.client.Skills;
...
public class CustomInterfaces extends RSInterface {
	...
	private static void questTabInterface3() {
		...
		for(int i = 55207; i < 55240; i++) {
			...
			y += 16;
			k++;
			if(i == 55207 || i == 55208 || i == 55209 || i == 55210 || i == 55211
			|| i == 55212 || i == 55213 || i == 55214 || i == 55215 || i == 55216) {
	...
	private static void quest_tab() {
		...
		addText(55067, "Ikov 2", fonts, 2, 37375, false, true);
	...
	private void playersOnline() {
		...
		addText(57007, "Www.ikov2.org", 0xff9933, true, true, -1, tda, 0);
	...
	public static void boltEnchantInterface(TextDrawingArea[] tda) {
        ...
        // Close button 
        addHoveredButton(49003, CLOSE_BUTTON_HOVER, CLOSE_BUTTON_HOVER, 17, 17,
                49004);
	...
	public static void miasmics() {
		...
		interfaceCache[32600].valueIndexArray = new int[][] {{ 4, 3214, 557 }, { 4, 3214, 566 }, { 4, 3214, 562 }, { 10, 1688, 13867, 10, 1688, 13869, 10, 1688, 13941, 10, 1688, 13943 }, { 1, 6 } };
		...
		interfaceCache[32620].valueIndexArray = new int[][] {{ 4, 3214, 557 }, { 4, 3214, 566 }, { 4, 3214, 562 }, { 10, 1688, 13867, 10, 1688, 13869, 10, 1688, 13941, 10, 1688, 13943 }, { 1, 6 } };    
		...
		interfaceCache[32640].valueIndexArray = new int[][] {{ 4, 3214, 557 }, { 4, 3214, 566 }, { 4, 3214, 565 }, { 10, 1688, 13867, 10, 1688, 13869, 10, 1688, 13941, 10, 1688, 13943 }, { 1, 6 } };
		...
		interfaceCache[32660].valueIndexArray = new int[][] {{ 4, 3214, 557 }, { 4, 3214, 566 }, { 4, 3214, 565 }, { 10, 1688, 13867, 10, 1688, 13869, 10, 1688, 13941, 10, 1688, 13943 }, { 1, 6 } };
	}
	...
	public static void runesBox3(int id, String spellName, String desc, int level, int rune1, int rune1amt, int rune2, int rune2amt, int rune3, int rune3amt) {
		...
		interfaceCache[(id + 10)].valueIndexArray = new int[][] { { 10, 1688, 13867, 10, 1688, 13869, 10, 1688, 13941, 10, 1688, 13943 } };
	...
	public static void ancientMagicTab(TextDrawingArea[] tda) {
		...
		int[] itfChildren = { 1195, 12939, 12987, 13035, 12901, 12861, 13045, 32600, 
		12963, 13011, 13053, 12919, 12881, 13061, 32620, 12951, 12999, 13069, 
		12911, 12871, 13079, 32640, 12975, 13023, 13087, 12929, 12891, 13095, 32660, 
		1196, 12940, 12988, 13036, 12902, 12862, 13046, 32601, 12964, 13012, 
		13054, 12920, 12882, 13062, 32621, 12952, 13000, 13070, 12912, 12872, 
		13080, 32641, 12976, 13024, 13088, 12930, 12892, 13096, 32661 };
		tab.totalChildren(itfChildren.length);
		int i1 = 0;int xPos = 18;
	...
	public static void configureLunar(TextDrawingArea[] TDA) {
		...
		addLunar3RunesSmallBox(30064, 9075, 563, 557, 1, 0, 1, 30012, 30006, 68, "Training Teleports", "Teleport to easy monsters.", TDA, 228, 0, 5);
		addLunar3RunesBigBox(30075, 9075, 563, 557, 1, 0, 3, 30012, 30006, 69, "Tele Group Moonclan", "Teleports your group to\\nmoonclan.", TDA, 229, 0, 5);
		addLunar3RunesSmallBox(30083, 9075, 563, 557, 1, 0, 5, 30012, 30006, 70, "Skilling Areas", "Teleport to skillable locations.", TDA, 230, 0, 5);
		...
		addLunar3RunesSmallBox(30106, 9075, 563, 555, 1, 0, 0, 30012, 30004, 71, "Minigames", "Teleport to minigames.", TDA, 233, 0, 5);
		addLunar3RunesBigBox(30114, 9075, 563, 555, 1, 0, 4, 30012, 30004, 72, "Tele Group Waterbirth", "Teleports your group to\\nwaterbirth.", TDA, 234, 0, 5);
		...
		addLunar3RunesSmallBox(30138, 9075, 563, 554, 1, 1, 2, 30012, 30003, 74, "Dungeons", "Teleport to dungeons.", TDA, 237, 0, 5);
		...
		addLunar3RunesSmallBox(30162, 9075, 563, 555, 1, 1, 3, 30012, 30004, 77, "Quests", "Teleport to start quests.", TDA, 240, 0, 5);
		...
		addLunar3RunesSmallBox(30226, 9075, 563, 555, 2, 2, 9, 30012, 30004, 84, "Wilderness Areas", "Teleport to the wilderness.", TDA, 248, 0, 5);
		...
		/******** Cut Off Limit **********/
		addLunar3RunesSmallBox(30250, 9075, 563, 555, 2, 2, 9, 30012, 30004, 86, "City Teleports", "Teleport to various citys.", TDA, 251, 0, 5);
		...
		addLunar3RunesSmallBox(30266, 9075, 563, 555, 2, 2, 7, 30012, 30004, 88, "Boss Teleports", "Teleport to Bosses on Ikov.", TDA, 253, 0, 5);
