...
import org.ikov.client.graphics.rsinterface.CustomInterfaces;
import org.ikov.client.graphics.rsinterface.SummoningInterfaceData;
	...
	//	int j = stream.getUnsignedShort();
		...
		while (stream.position < stream.buffer.length) {
			...
			if (rsInterface.type == 4) {
				rsInterface.message = stream.getString().replaceAll("RuneScape", "Ikov");
