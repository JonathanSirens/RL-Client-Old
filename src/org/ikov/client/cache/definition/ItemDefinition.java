...
import org.ikov.client.Signlink;
...
public final class ItemDefinition {
	...
	public static ItemDefinition get(int id) {
		...
		case 19670:
			...
			break;
		case 15017: 
			itemDef.name = "Donator Ring";
			itemDef.description = "A ring that will grant you double xp when worn..".getBytes();
			itemDef.actions = new String[5];
		...
		case 7629:
			...
			itemDef.actions[4] = "Drop";	
			itemDef.description = "This scroll can be redeemed for a $125 Ikov payment. [137,500 credits]".getBytes();
		...
		case 10934:
			...
			itemDef.description = "This scroll can be redeemed for a $25 Ikov payment. [27,875 credits]".getBytes();
			itemDef.actions = new String[5];
			itemDef.actions[0] = "Redeem";
			break;
		case 10935:
			...
			itemDef.description = "This scroll can be redeemed for a $50 Ikov payment. [55,750 credits]".getBytes();
			itemDef.actions = new String[5];
			itemDef.actions[0] = "Redeem";
		break;
		case 10943:
			...
			itemDef.description = "This scroll can be redeemed for a $10 Ikov payment. [10,000 credits]".getBytes();
			itemDef.actions = new String[5];
			itemDef.actions[0] = "Redeem";
			break;
		case 995:
