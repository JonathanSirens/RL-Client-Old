package org.runelive.alertify.ui;
...
import org.runelive.alertify.AlertifyColorPair;
import org.runelive.alertify.AlertifyConfig;
import org.runelive.alertify.themes.AlertifyTheme;
import org.runelive.alertify.util.Optional;
...
public class AlertifyWindow extends JWindow {
	...
	public AlertifyWindow(AlertifyTheme theme, AlertifyConfig config) {
		...
		label.setFont(font.isPresent() ? font.get() : theme.getFont()); // checking
		// null
		// state
		// to
		// see
