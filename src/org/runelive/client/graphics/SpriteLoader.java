...
public class SpriteLoader {
	...
	public static void loadSprites() {
		try {
			ByteBuffer index = new ByteBuffer(readFile(Signlink.getCacheDirectory() + "/packed_images/" + "sprites.idx"));
			ByteBuffer data = new ByteBuffer(readFile(Signlink.getCacheDirectory() + "/packed_images/" + "sprites.dat"));
