...
public class CustomInterfaces extends RSInterface {
	...
	public static void configureLunar(TextDrawingArea[] TDA) {
		...
		addLunar3RunesSmallBox(30266, 9075, 563, 555, 2, 2, 7, 30012, 30004, 88, "Boss Teleports", "Teleport to Bosses on RuneLive.", TDA, 253, 0, 5);
	...
	private void bankInterface() {
		interfaceCache[5383].message = "     The Bank of RuneLive";
