    ...
    public static void load() {
        try {
            ...
            try {
                ...
                GameFrameConstants.gameframeType = stream.readBoolean() ? GameFrameConstants.GameFrameType.FRAME_554 : GameFrameConstants.GameFrameType.FRAME_525;
    ...
    private static void saveBlock() {
        try {
            ...
            if (stream != null) {
                ...
                stream.writeBoolean(GameFrameConstants.gameframeType == GameFrameConstants.GameFrameType.FRAME_525 ? false : true);
                ...
                stream.writeByte(Client.instance.variousSettings[502]); //Split private chat?
